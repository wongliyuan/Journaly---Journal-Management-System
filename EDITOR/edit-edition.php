...
<main class="main-content">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" style="background-color: #F97C7C; color: #fff; padding: 10px 15px; font-size: 16px; width: fit-content; border: none; border-radius: 4px; cursor: pointer; text-align: center; transition: background-color 0.3s ease;" onmouseover="this.style.backgroundColor='#FDAAAA'" onmouseout="this.style.backgroundColor='#F97C7C'">
            Update
        </button>
    </form>
    </div>
