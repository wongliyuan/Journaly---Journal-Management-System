...
<nav>
      ...
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          <ul class="lists">
          <li class="list">
              <a href="../EDITOR/my-dashboard.php" class="nav-link">
              <i class='bx bx-line-chart icon'></i>
                <span class="link">My Dashboard</span>
              </a>
            </li>
            <li class="list">
              <a href="../EDITOR/my-workspace.php" class="nav-link">
              <i class='bx bx-briefcase icon'></i>
                <span class="link">My Workspace</span>
              </a>
            </li>
            <li class="list">
              <a href="../EDITOR/my-invitation.php" class="nav-link">
              <i class='bx bx-task icon'></i>
                <span class="link">My Invitations</span>
              </a>
            </li>
            <li class="list">
              <a href="../EDITOR/my-notification.php" class="nav-link">
            ...
            <li class="list">
              <a href="../EDITOR/my-chat.php" class="nav-link">
            ...
            <li class="list">
              <a href="../EDITOR/my-profile.php" class="nav-link">
